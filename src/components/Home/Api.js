...
export const safety = [
    {
        id: 1, imgurl: img7, title: "INCIDENT REPORTING IS CRITICAL TO YOUR WORKPLACE SAFETY PROGRAM", content: "All incidents should be reported, documented, and investigated which is why incident reporting is critical to a successful workplace safety and health program.", cat: 'safety'
    },

    {
        id: 2, imgurl: img8, title: "OSHA STANDARDS FOR HEARING PROTECTION: AVOID HEARING LOSS", content: "All incidents should be reported, documented, and investigated which is why incident reporting is critical to a successful workplace safety and health program.", cat: 'safety'
    },
    {
        id: 3, imgurl: img9, title: "HAZARD COMMUNICATION AWARENESS AND WORKERS' RIGHT TO KNOW", content: "The goal of the Hazard Communication Standard (HCS) standard is to ensure that workers know about chemical hazards at work and how to protect themselves.", cat: 'safety'
    },
    {
        id: 4, imgurl: img10, title: "JOB HAZARD ANALYSIS (JHA): FOCUS ON INCIDENT PREVENTION", content: "Workplace safety isn't just something that you think about once a month at a safety meeting. Learn more about job hazard analysis and why it's important..", cat: 'safety'
    }
...
export const bollywood = [
    ...
    {
        id: 7, imgurl: img18, title: "Alia Bhatt reveals how she will react if a girl tries to hit on her boyfriend Ranbir Kapoor", content: 'Alia Bhatt and Ranveer Singh were at their candid best at the trailer launch of their upcoming film, Gully Boy. ', cat: 'bollywood'
    },
    {
        id: 8, imgurl: img19, title: "Aishwarya, Abhishek and daughter Aaradhya return to Mumbai post their New Year getaway", content: 'Aishwarya Rai Bachchan, Abhishek Bachchan and daughter Aaradhya returned to Mumbai today after ringing in 2019 abroad. ', cat: 'bollywood'
    },
    {
    ...
    {
        id: 10, imgurl: img21, title: " Virat Kohli watched Anushka Sharma’s latest film Zero in Melbourne", content: 'Anushka Sharma, Shah Rukh Khan and Katrina Kaif starrer Zero hit the theatres today and fans are going gaga over the lead actors performances in the film. ', cat: "bollywood"
    },
    {
        id: 11, imgurl: img22, title: "  Ajay Devgn and Kajol head to Thailand for a holiday with their children Nysa and Yug", content: 'As Christmas and New Year’s Eve approaches, it’s the time of the year where festive fervour grips Bollywood stars and celebs will be bringing in 2019 in the company of their family and friends. ', cat: 'bollywood'
    }
